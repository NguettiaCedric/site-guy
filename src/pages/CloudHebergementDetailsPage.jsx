...
const CloudHebergementDetailsPage = () => {
  const breadcrumbs = [
    { label: 'Accueil', link: '/' },
    // { label: 'Projects', link: '/Projects' },
    { label: 'Cloud & Hebergement', link: null }
  ];

  return (
    <>
      <PageHeader title="Cloud & Hebergement" breadcrumbs={breadcrumbs} />
      <section className="ep-project-details-section pt-120">
        <div className="container">
          ...
          <div className="project-description">
            <h3 className="title split-text right">cloud & hebergement</h3>
...
export default CloudHebergementDetailsPage
