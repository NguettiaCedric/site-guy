...
const SapBusinessOneDetailsPage = () => {
  const breadcrumbs = [
    { label: 'Accueil', link: '/' },
    // { label: 'Projects', link: '/Projects' },
    { label: 'SAP Business One', link: null }
  ];

  return (
    <>
      <PageHeader title="SAP Business One" breadcrumbs={breadcrumbs} />
      <section className="ep-project-details-section pt-120">
        <div className="container">
          ...
          <div className="project-description">
            <h3 className="title split-text right">SAP Business One</h3>
...
export default SapBusinessOneDetailsPage
