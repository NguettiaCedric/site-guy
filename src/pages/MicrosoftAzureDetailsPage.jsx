...
const MicrosoftAzureDetailsPage = () => {
  const breadcrumbs = [
    { label: 'Accueil', link: '/' },
    // { label: 'Projects', link: '/Projects' },
    { label: 'Microsoft Azure', link: null }
  ];

  return (
    <>
      <PageHeader title="Microsoft Azure" breadcrumbs={breadcrumbs} />
      <section className="ep-project-details-section pt-120">
        <div className="container">
          ...
          <div className="project-description">
            <h3 className="title split-text right">Microsoft Azure</h3>
...
export default MicrosoftAzureDetailsPage
