...
const CyberSecuriteDetailsPage = () => {
  const breadcrumbs = [
    { label: 'Accueil', link: '/' },
    // { label: 'Projects', link: '/Projects' },
    { label: 'Cybersecurité', link: null }
  ];

  return (
    <>
      <PageHeader title="Cybersecurité" breadcrumbs={breadcrumbs} />
      <section className="ep-project-details-section pt-120">
        <div className="container">
          ...
          <div className="project-description">
            <h3 className="title split-text right">Cybersecurité</h3>
...
export default CyberSecuriteDetailsPage
