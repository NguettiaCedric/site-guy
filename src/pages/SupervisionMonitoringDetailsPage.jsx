...
const SupervisionMonitoringDetailsPage = () => {
  const breadcrumbs = [
    { label: 'Accueil', link: '/' },
    // { label: 'Projects', link: '/Projects' },
    { label: 'Supervision & Monitoring', link: null }
  ];

  return (
    <>
      <PageHeader title="Supervision & Monitoring" breadcrumbs={breadcrumbs} />
      <section className="ep-project-details-section pt-120">
        <div className="container">
          ...
          <div className="project-description">
            <h3 className="title split-text right">Supervision & Monitoring</h3>
...
export default SupervisionMonitoringDetailsPage
