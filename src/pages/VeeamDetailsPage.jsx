...
const VeeamDetailsPage = () => {
  const breadcrumbs = [
    { label: 'Accueil', link: '/' },
    // { label: 'Projects', link: '/Projects' },
    { label: 'VEEAM', link: null }
  ];

  return (
    <>
      <PageHeader title="VEEAM" breadcrumbs={breadcrumbs} />
      <section className="ep-project-details-section pt-120">
        <div className="container">
          ...
          <div className="project-description">
            <h3 className="title split-text right">VEEAM</h3>
...
export default VeeamDetailsPage
