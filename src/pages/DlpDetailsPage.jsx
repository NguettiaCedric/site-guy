...
const DlpDetailsPage = () => {
  ...
  return (
    <>
      <PageHeader title="DLP (Data Loss Prevention)" breadcrumbs={breadcrumbs} />
      <section className="ep-project-details-section pt-120">
        <div className="container">
          ...
          <div className="project-description">
            <h3 className="title split-text right">DLP</h3>
