...
const SauvegardeRestaurationDetailsPage = () => {
  const breadcrumbs = [
    { label: 'Accueil', link: '/' },
    // { label: 'Projects', link: '/Projects' },
    { label: 'Sauvegarde & restauration', link: null }
  ];

  return (
    <>
      <PageHeader title="Sauvegarde & Restauration" breadcrumbs={breadcrumbs} />
      <section className="ep-project-details-section pt-120">
        <div className="container">
          ...
          <div className="project-description">
            <h3 className="title split-text right">Sauvegarde & Restauration</h3>
...
export default SauvegardeRestaurationDetailsPage
