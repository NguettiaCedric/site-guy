        ...
        <div className="row">
          <div className="col-lg-4">
            <div className="short-info text-center text-lg-start">
              <SectionTitle subTitle="Our Team" title="Transforming Challenges into Best" extraClassName="mb-40 text-center text-lg-start" />
              ...
              <Link to="/contact" className="theme-btn mt-40 position-relative d-inline-flex align-items-center">
                Contact Us
                  ...
                  <motion.div
                    ...
                    <div className="team-item-two">
                      <div className="img rounded-20 overflow-hidden position-relative">
                        <img loading="lazy" src={team.image} className="img-fluid w-100" />
                        <div
