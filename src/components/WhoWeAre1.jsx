...
import Sauvegarde from '../assets/images/img/sauvegarde-1.jpg'; 
...
const WhoWeAre1 = () => {
  ...
  return (
    <section className="ep-who-we-area-section pt-5 pb-1" ref={counterRef}>
      <div className="container">
        <div className="row">
          <div className="col-xl-6">
            <motion.div
              ...
              <div className="img overflow-hidden">
                <img loading="lazy" src={Sauvegarde} style={{
                  width: "490px",
                  height: "457px",
                  borderRadius: "40px",
                  objectFit: "cover"
                }} 
              alt="who-we-are" className="img-fluid w-100" />
              </div>
          ...
          <div className="col-xl-6 align-self-center">
            <div className="short-info text-center text-md-start pb-4">
              <SectionTitle title="Sauvegarde & Restauration" extraClass="mb-20 text-center text-md-start" />
              <motion.p
