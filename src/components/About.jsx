        ...
        <div className="row">
          ...
          <div className="col-xl-6 col-lg-9 mx-auto">
            <div className="about-text">
              <SectionTitle subTitle="A propos" title="Libérer le pouvoir de la technologie" extraClassName="mb-20" />
              <p>
                CADENA est une entreprise innovante spécialisée dans les solutions technologiques et la transformation digitale des organisations.
                Nous accompagnons les entreprises dans la modernisation de leurs systèmes à travers des services sur mesure et performants :
                ...
                <div className="row">
                  <div className="col-sm-6 list-wrapper">
                    <ul className="list-unstyled list-info">
                      <li>
                        <i className="fa-solid fa-circle-check"></i> Microsoft Azure Cloud
                      </li>
                      <li>
                        <i className="fa-solid fa-circle-check"></i> SAP business One
                      </li>
                      <li>
                        <i className="fa-solid fa-circle-check"></i>Cloud & Hebergement</li>
                      <li>
                        <i className="fa-solid fa-circle-check"></i> DLP </li>
                    </ul>
                  </div>
                  <div className="col-sm-6 list-wrapper">
                    <ul className="list-unstyled list-info">
                      <li>
                        <i className="fa-solid fa-circle-check"></i> CyberSecurité
                      </li>
                      <li>
                        <i className="fa-solid fa-circle-check"></i>VEEAM</li>
                      
                      <li>
                        <i className="fa-solid fa-circle-check"></i> Sauvegarde & Restauration 
                      </li>

                      <li>
                        <i className="fa-solid fa-circle-check"></i> Développement d'application web et Mobile
                      </li>
