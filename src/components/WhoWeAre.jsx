...
import cloudImg from '../assets/images/img/cloudImg.jpg';
        ...
        <div className="row">
          <div className="col-xl-6 align-self-center">
            <div className="short-info text-center text-md-start pb-4">
              <SectionTitle title="Découvrez Microsoft Azure" extraClass="mb-20 text-center text-md-start" />
              <motion.p
          ...
          <div className="col-xl-6">
            <motion.div
              ...
              <div className="img overflow-hidden">
                <img loading="lazy" src={cloudImg} style={{
                  width: "490px",
                  height: "457px",
                  borderRadius: "40px",
                  objectFit: "cover"
