...
import bannerImg1 from '../assets/images/banner/banner-img-1-.png';
        ...
        <div className="row">
          <div className="col-lg-5 align-self-center">
            <motion.div
              ...
              <h1 className="banner-title heading-style1">L’innovation de demain</h1>
          ...
          <div className="col-lg-7 col-md-10 mx-auto ps-xl-0">
            ...
            >
              <img loading="lazy" src={bannerImg1} alt="banner-img" className="img-fluid w-100" />
            </motion.div>
