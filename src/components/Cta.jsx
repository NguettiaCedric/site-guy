        ...
        <div className="row g-4">
          <div className="col-lg-6 align-self-center">
            <div className="cta-text d-flex align-items-center gap-4">
              ...
              <h3 className="info">Favoriser le progrès grâce à la technologie</h3>
            </div>
          </div>
          <div className="col-lg-6 align-self-center">
            <div className="cta-form">
              <form action="#">
                <div className="d-sm-flex gap-3 align-items-center">
                  ...
                  {/* <button className="theme-btn mt-3 mt-sm-0 theme-btn-primary position-relative flex-shrink-0">En savoir plus</button> */}
